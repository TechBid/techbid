...
def _generate_ai_jobs_groq(store: MySQLStore) -> int:
    ...
    try:
        ...
        prompt = (
            ...
            "Return ONLY a JSON array with 1 object. No markdown, no backticks, no explanation.\n"
            '{"title": "Job Title Here", "description": "FULL JOB DESCRIPTION TEXT HERE", "job_type": "fixed", "budget_usd": 3000, "duration": "4 weeks", "robot_winner_name": "Aisha M."}\n\n'
            "CRITICAL INSTRUCTIONS FOR description FIELD:\n"
            "- Must be a PLAIN TEXT STRING, not JSON\n"
            "- Must include detailed job posting (250+ words)\n"
            "- MUST start with 'Overview:' followed by clear project summary\n"
            "- MUST include 'Project Scope:' with specific deliverables\n"
            "- MUST include 'Responsibilities:' with specific tasks\n"
            "- MUST include 'Requirements:' with required skills\n"
            "- MUST include 'Nice to Have:' with bonus skills\n"
            "- Use newline + dash for each bullet point: '- text here'\n"
            "- Separate sections with blank lines\n\n"
            "EXAMPLE format (follow this EXACTLY):\n"
            "\"Overview:\\n- We need a web developer to build an e-commerce site\\n- Should handle 10k+ products\\n\\nProject Scope:\\n- Design responsive frontend\\n- Build secure backend\\n\\nResponsibilities:\\n- Code the feature\\n- Test thoroughly\\n\\nRequirements:\\n- 5+ years experience\\n- React/Node expertise\\n\\nNice to Have:\\n- Portfolio links\"\n\n"
            "Generate for: {category}\n"
            "- Budget: $200-$5000\n"
            "- Type: fixed, hourly, or daily\n"
            "- Duration: realistic timeline\n"
            "- Winner: Random professional name like 'Kenji S.' or 'Priya N.'\n\n"
