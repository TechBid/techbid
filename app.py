...
def _generate_ai_jobs_groq(store: MySQLStore) -> int:
    ...
    try:
        ...
        prompt = (
            ...
            "  * Role-based: 'Senior React Developer for Fintech Startup'\n"
            "  * Problem-based: 'Build Real-time Analytics Dashboard'\n"
            "  * Outcome-based: 'Launch Healthcare Mobile App MVP in 6 Weeks'\n"
            "  * Tech-based: 'AWS Infrastructure Setup - SaaS Platform'\n"
            "  Never repeat the same title pattern or domain twice.\n"
...
def _generate_ai_jobs_gemini(store: MySQLStore) -> int:
    ...
    try:
        ...
        prompt = (
            ...
            "- title: Create diverse titles varying the pattern AND domain:\n"
            "  * 'Senior Backend Engineer for Fintech Startup'\n"
            "  * 'Build Healthcare Analytics Platform'\n"
            "  * 'Launch Social Media Management SaaS MVP'\n"
            "  * 'React Development - EdTech Learning Platform'\n"
            "  Use different structures and industries, not just e-commerce every time.\n"
